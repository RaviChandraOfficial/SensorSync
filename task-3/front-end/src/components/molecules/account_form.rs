...
pub fn account_form(props: &Props) -> Html {
    ...
    html! {
      <form {onsubmit}>
        ...
        <BBTextInput data_test="email_id" label="email_id" placeholder="Mention your Email_id" class="input" input_type={InputType::Email} onchange={emailid_onchange} />
